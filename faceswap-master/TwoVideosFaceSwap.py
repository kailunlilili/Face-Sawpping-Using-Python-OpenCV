...
if __name__ == "__main__":
    source_path = './test video/MrRobot.mp4'
    target_path = './test video/dance2.mp4'
    video_pose_detection(source_path)
    face_swap_between_image_and_video(target_path)
    # video_pose_detection(target_path)
    # face_swap_between_image_and_video(source_path)
